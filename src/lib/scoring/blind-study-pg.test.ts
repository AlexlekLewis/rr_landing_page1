...
const CASES: Profile[] = [
  ...
  { id: "H", who: "16yo M gun in OPEN sub-district", age: 16, gender: "M", code: "SD1", games: 12, format: "t20", batAvg: 35, batSR: 130, expect: { stream: "performance", placedBand: "14-16", review: true, playFlag: "play_up_review" } },
