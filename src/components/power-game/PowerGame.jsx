...
<section style="background:var(--s50);">
  <div class="wrap">
    ...
    <div class="grid g3">
      ...
      <div class="card"><span class="tag">Ages 17–Open</span><h3 style="font-size:16px; margin:11px 0 7px;">The Senior Performer</h3><p style="font-size:13px; color:var(--slate); line-height:1.5; font-weight:500;">Premier and senior club players adding power dimensions to a proven game — and chasing the next level of cricket.</p></div>
