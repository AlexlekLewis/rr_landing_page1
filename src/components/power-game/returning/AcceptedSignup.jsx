...
const ACCEPTED_CONFIG = {
  ...
  docTitle: 'Accept your spot — Power Pre-Season',
  gateTitle: 'Accept your spot',
  gateBlurb: 'This is the private page to accept your place in the Power Pre-Season. Enter the access code from your email to continue.',
  headerTitle: 'Accept your spot',
  headerLead: 'You’ve been offered a place in the Power Pre-Season. Accept your spot — confirm a few details so we can match your application, choose your kit, and secure it.',
