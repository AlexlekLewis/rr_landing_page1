...
const JRT3Success = () => {
    ...
    const fadeUp = { hidden: { opacity: 0, y: 24 }, visible: (d = 0) => ({ opacity: 1, y: 0, transition: { duration: 0.6, ease: 'easeOut', delay: d } }) };

    return (
        <div className="min-h-screen bg-rr-dark text-white font-sans flex flex-col selection:bg-rr-pink selection:text-white relative overflow-hidden">
            <div className="absolute top-[-10%] left-[-10%] w-[500px] h-[500px] rounded-full bg-rr-pink/10 blur-[120px] pointer-events-none" />
            <div className="absolute bottom-[-10%] right-[-10%] w-[500px] h-[500px] rounded-full bg-rr-blue/15 blur-[120px] pointer-events-none" />
            ...
            <main className="flex-1 flex items-center justify-center px-6 py-32">
                <div className="relative z-10 max-w-2xl w-full mx-auto text-center">
                    <motion.div initial="hidden" animate="visible" custom={0} variants={fadeUp} className="mb-10">
                        <img src="/assets/MELBOURNE_OFFICIAL.png" alt="RRA Melbourne" className="h-16 md:h-20 mx-auto brightness-0 invert" />
                    </motion.div>
                    ...
                    <motion.div initial="hidden" animate="visible" custom={0.25} variants={fadeUp} className="mb-4">
                        <p className="text-rr-pink font-bold uppercase tracking-widest text-sm mb-3">Enrolment Confirmed</p>
                        <h1 className="text-5xl sm:text-6xl md:text-7xl font-black uppercase tracking-tight leading-none">
                            YOU'RE <span className="text-transparent bg-clip-text bg-gradient-to-r from-rr-pink to-rr-blue">IN.</span>
                        </h1>
                    </motion.div>
                    ...
                    <motion.p initial="hidden" animate="visible" custom={0.4} variants={fadeUp} className="text-xl md:text-2xl font-semibold text-white/90 leading-relaxed mb-6">
                        Welcome to Junior Royals — Term 3, 2026.
                    </motion.p>
                    ...
                    <motion.div initial="hidden" animate="visible" custom={0.55} variants={fadeUp} className="bg-white/5 border border-white/10 rounded-2xl px-6 py-5 mb-6 text-left backdrop-blur-sm">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-white/60 leading-relaxed">A member of our team will confirm your place and session time via email within 24 hours of receipt, on the first business day following your online enrolment. Our office hours are Monday to Friday, 8:30am – 5:30pm.</p>
                            </div>
                        </div>
                    </motion.div>
                    <motion.div initial="hidden" animate="visible" custom={0.6} variants={fadeUp} className="bg-white/5 border border-white/10 rounded-2xl px-6 py-5 mb-10 text-left backdrop-blur-sm">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-white/60">Email us at <a href="mailto:info@rramelbourne.com" className="text-rr-pink font-bold hover:underline">info@rramelbourne.com</a></p>
                            </div>
                        </div>
                    </motion.div>
                    <motion.div initial="hidden" animate="visible" custom={0.7} variants={fadeUp}>
                        <Link to="/" className="inline-flex items-center gap-3 bg-rr-pink hover:bg-rr-light-pink text-white font-black uppercase tracking-widest px-10 py-4 rounded-full transition-all duration-300 hover:shadow-[0_0_28px_rgba(229,6,149,0.45)] group">
                            Back to Home
                    ...
                    <motion.p initial="hidden" animate="visible" custom={0.85} variants={fadeUp} className="mt-12 text-xs font-black uppercase tracking-[0.3em] text-white/20">HALLA BOL</motion.p>
                </div>
            </main>
            <Footer />
        </div>
