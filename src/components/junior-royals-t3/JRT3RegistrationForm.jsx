...
const JRT3RegistrationForm = () => {
    ...
    const handleSubmit = async (ev) => {
        ...
        try {
            ...
            window.location.href = stripeLink || '/junior-royals-t3/success';
        } catch (err) {
            console.error(err);
                                ...
                                {form.location && (
                                    <div>
                                        ...
                                        <select name="group_selection" value={form.group_selection} onChange={handleChange} className={ic('group_selection')}>
                                            ...
                                            <option value="ages-5-6">Ages 5–6 (Minis)</option>
                                            <option value="ages-7-9">Ages 7–9 (Warriors)</option>
                                            <option value="ages-10-12">Ages 10–12 (Challengers)</option>
                                            <option value="ages-13-15">Ages 13–15 (Juniors)</option>
                                            <option value="ages-16-17">Ages 16–17 (Seniors)</option>
                                        </select>
