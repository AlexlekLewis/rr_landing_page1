...
export const PRODUCTS = [
  {
    ...
    madeToOrder: true,
    madeToOrderNote: 'Made to order. Available for pickup at Elite Cricket Centre (Cranbourne North) and Mickleham Indoor Sports Centre (Mickleham), and for postage. You will be updated via text message on your order status.',
