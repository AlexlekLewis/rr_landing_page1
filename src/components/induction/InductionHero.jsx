...
// Generic, reusable hero. `program` (optional) tweaks the eyebrow line so the
// same page can front any program launch via a ?program= query param.
const InductionHero = ({ program = '' }) => {
    const scrollToForm = () => {
            ...
            <div className="relative max-w-5xl mx-auto px-6 pt-32 pb-24 md:pt-40 md:pb-28 text-center">
                ...
                >
                    ...
                    <span className="text-xs font-bold text-rr-pink uppercase tracking-[0.3em]">
                        {program ? program : 'Rajasthan Royals Academy Melbourne'}
                    </span>
                </motion.div>
                ...
                >
                    Player<br /><span className="text-rr-pink">Induction</span>
                </motion.h1>
                ...
                <motion.p
                    ...
                    className="text-base md:text-lg text-white/70 font-medium max-w-2xl mx-auto leading-relaxed mb-10"
                >
                    Tell us a little about your game. It takes two minutes, puts you on our radar, and means we can match you to the right programs as they launch.
                </motion.p>
