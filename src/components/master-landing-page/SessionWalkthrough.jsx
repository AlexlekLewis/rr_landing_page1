...
const sessionBlocks = [
    ...
    },
    {
        ...
        duration: "40 min",
        accent: "rr-blue",
        description: "The bulk of this block is dedicated to short-range development and skill acquisition — structured, repetitive drills designed to build and refine core cricket skills under coached conditions. Within this block, dedicated time is also allocated to personalised technique work, where players work in focused 2-on-1 coaching groups on areas specific to their Individual Development Plan. IDP-specific time is rostered across the month so every player gets targeted attention.",
        why: "Every player's development trajectory is different. The short-range skill acquisition work builds the foundation — repetitive, intentional drills that ingrain movement patterns so deeply they become automatic under pressure. The personalised technique block ensures coaching is tailored, not generic. The 2-on-1 format means maximum feedback and nowhere to hide. Your child's Individual Development Plan drives every session — with specific IDP time rostered across the month so no skill gap goes unaddressed.",
        bullets: [
            "Short-range development and skill acquisition drills",
