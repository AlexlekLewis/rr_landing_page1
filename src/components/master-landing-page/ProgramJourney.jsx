            ...
            <div className="max-w-6xl mx-auto px-6 relative z-10">
                ...
                >
                    ...
                    <p className="text-lg text-white/50 max-w-2xl mx-auto leading-relaxed">
                        This isn't a drop-in clinic. It's a structured and periodised 12-week program built to give you the T20 skills, confidence, and coaching you need to push for representative selection and higher honours, and put yourself on the radar of Royals Group scouts.
                    </p>
                </motion.div>
