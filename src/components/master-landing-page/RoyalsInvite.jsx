                    ...
                    <div className="relative z-10 p-8 md:p-14">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-6 mb-10">
                            ...
                            <div className="text-center sm:text-left">
                                <p className="text-white/50 text-xs font-bold uppercase tracking-widest mb-1">Season 1 · 2026</p>
                                <p className="text-white font-black text-lg uppercase tracking-wide">T20 Elite Program</p>
                            </div>
                        </div>
