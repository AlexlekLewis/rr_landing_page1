    ...
    return (
        <section className="relative min-h-screen flex items-center overflow-hidden bg-rr-dark">
            ...
            <div
                ...
                style={{ backgroundImage: "url('/assets/hero-ipl-action.png')", backgroundSize: 'auto 100%', backgroundPosition: 'right top' }}
            />
            {/* Gradient overlays */}
            ...
            <div className="relative z-20 container mx-auto px-6 pt-32 pb-24 max-w-4xl">
                ...
                >
                    ...
                    <span className="text-xs font-bold text-rr-pink uppercase tracking-widest">Registrations Opening Soon — July 2026</span>
                </motion.div>
                ...
                >
                    The Junior Royals Holiday Camp runs across the July school holidays for boys and girls aged 7–14. Two Melbourne locations.
                </motion.p>
