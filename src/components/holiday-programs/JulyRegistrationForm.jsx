                ...
                >
                    ...
                    <div className="mb-8">
                        ...
                        <select name="location" value={form.location} onChange={handleChange} className={inputClass(errors.location)}>
                            ...
                            <option value="bundoora" disabled>Cutting Edge Cricket — Bundoora | 30 June – 2 July (Sold Out)</option>
                            <option value="hallam" disabled>Hallam | 7 – 9 July (Sold Out)</option>
