        ...
        <section className="py-24 px-6 lg:px-8 relative z-10 bg-black overflow-hidden">
            ...
            >
                <div className="text-center mb-16 space-y-4">
                    <motion.h2 variants={fadeIn} className="text-3xl md:text-5xl font-black text-white uppercase tracking-tight">
                        Phase Effectiveness
                    </motion.h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {phases.map((phase, index) => (
                        <motion.div
                            key={index}
                            variants={fadeIn}
                            className="bg-zinc-900 border border-zinc-800 rounded-3xl p-8 relative overflow-hidden group hover:border-zinc-700 transition-colors duration-500"
                        >
                            {/* Ambient Glow */}
                            <div className={`absolute top-0 right-0 w-32 h-32 bg-gradient-to-br ${phase.color} opacity-10 rounded-full blur-2xl group-hover:opacity-20 transition-opacity duration-500`} />

                            <div className="relative z-10">
                                <div className="flex justify-between items-start mb-8">
                                    <div className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${phase.color} flex items-center justify-center p-[2px]`}>
                                ...
                                <span className="text-rr-pink font-semibold text-sm uppercase tracking-wider mb-2 block">
                                    {phase.weeks}
                                </span>
