    ...
    },
    {
        ...
        coaches: [
            ...
            },
            {
                ...
                bio: "Sam Coates is one of Melbourne Premier Cricket's most decorated wicket-keepers, and one of the most technically accomplished keepers produced by Victorian club cricket in the modern era.\n\nOver 13 seasons at Prahran Cricket Club, Sam set keeping records that remain untouched. His 331 career dismissals are the most in the club's history. He holds the record for most dismissals in a season with 47 — and also occupies second, third, and fourth on that same list. He has taken six dismissals in an innings on three separate occasions. At representative level, he played for the Canberra Comets in the National 2nd XI competition across both four-day and T20 formats.\n\nIn 2026, Sam was selected to represent both Victoria and Australia at Masters Over 40s level — a reflection of keeping standards that have remained consistently elite across two decades of competition.\n\nAs a coach, Sam holds a Cricket Australia Level 2 accreditation and has served as a Cricket Victoria Course Presenter in Wicket-Keeping since 2019 — a role that places him among a small group of specialists trusted to shape how the craft is taught across the state. He holds specialist keeping coaching contracts with Melbourne University CC, Brighton Grammar, Melbourne Grammar, and Caulfield Grammar.\n\nAt the Rajasthan Royals Cricket Academy Melbourne, Sam works exclusively on the technical and tactical dimensions of wicket-keeping — the footwork, glove work, game awareness, and composure under pressure that separate good keepers from great ones.",
                tag: "Wicket-Keeping",
            },
        ],
    },
...
const specialties = [
    ...
    { title: "Wicketkeeping Craft", coach: "Sam Coates", color: "from-rr-pink to-rr-blue", desc: "Footwork, glove work, game awareness, and composure under pressure — the technical and tactical craft that separates good keepers from great ones." },
