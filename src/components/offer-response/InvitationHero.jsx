            ...
            <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
                ...
                >
                    ...
                    <p className="text-white font-bold text-xl md:text-2xl mt-8 mb-4 border-l-4 border-rr-pink pl-6 text-left">
                        We are delighted to now invite you to an assessment session on <span className="text-rr-pink">Sunday March 1 at XXpm at Cutting Edge Cricket in Bundoora. This sessions forms a key part of the final offers that will be made to successful applicants.</span>
                    </p>
                </motion.div>
