...
const MicklehamForm = () => {
    ...
    // Under 11s aren't eligible for the Elite trial — they're routed to Junior
    ...
    const validate = () => {
        ...
        else if (notEligible) e.player_dob = 'The Elite trial is for ages 11+ — please register for Junior Royals above.';
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // navigate there. The success route (/PGP2026/mickleham/success) reads
            // this one-shot stash, fires the Meta Pixel Lead conversion, and clears it.
            const firstName = (form.player_name || '').trim().split(' ')[0] || 'You';
            try {
                sessionStorage.setItem('mickleham_confirmation', JSON.stringify({
                    firstName,
                    email: form.parent_email.trim(),
                }));
            } catch (_) { /* sessionStorage may be unavailable; success page falls back to generic copy */ }
            navigate('/PGP2026/mickleham/success');
        } catch (err) {
            ...
            <div className="max-w-2xl mx-auto px-6">
                <div className="text-center mb-12">
                    <div className="inline-flex items-center gap-2 bg-rr-pink/10 border border-rr-pink/30 rounded-full px-4 py-2 mb-6">
                        ...
                        <span className="text-xs font-bold text-rr-pink uppercase tracking-widest">Elite Trial · 10:30am–12:00pm · Ages 11+</span>
                    </div>
                            ...
                            <div className="space-y-5">
                                ...
                                {notEligible && (
                                    <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                                        ...
                                        <p className="text-rr-charcoal text-sm font-medium mt-1">The Elite trial is for ages 11+. Please register for <strong>Junior Royals</strong> instead — same quick form, just above. Everyone's welcome to play.</p>
