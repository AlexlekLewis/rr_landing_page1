                    ...
                    <div className="relative z-10 p-8 md:p-14">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-6 mb-10">
                            ...
                            <div className="text-center sm:text-left">
                                <p className="text-white/50 text-xs font-bold uppercase tracking-widest mb-1">May 7 Intake</p>
                        ...
                        <p className="text-white/60 text-sm font-medium leading-relaxed max-w-xl mb-10">
                            This invitation is not available to the general public. RRA participants only. Exclusively for those registered in the May 7 intake.
                        </p>
...
export default RoyalsInviteSection;
