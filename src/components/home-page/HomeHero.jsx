...
const HomeHero = ({ onRegisterClick }) => {
    return (
        <section className="relative min-h-screen flex items-end overflow-hidden bg-rr-dark">
            <div className="absolute inset-0 bg-cover bg-[center_top] bg-no-repeat md:hidden" style={{ backgroundImage: "url('/assets/hero-vaibhav.png')" }} />
            <div className="absolute inset-0 bg-cover bg-center bg-no-repeat hidden md:block" style={{ backgroundImage: "url('/assets/hero-vaibhav.png')" }} />
