...
const PROGRAMS = [
    { label: 'T20 Elite Program', route: '/eliteprogram2026', badge: 'Waitlist Only', badgeColor: 'bg-slate-500' },
    ...
    { label: 'Junior Royals', route: '/junior-royals', badge: 'Enrolling Now', badgeColor: 'bg-green-500' },
];

const HomeHero = ({ onRegisterClick }) => {
    return (
        <section className="relative min-h-screen flex items-end overflow-hidden bg-rr-dark">
            <div className="absolute inset-0 bg-cover bg-[center_top] bg-no-repeat md:hidden" style={{ backgroundImage: "url('/assets/hero-jaiswal.webp')" }} />
            <div className="absolute inset-0 bg-cover bg-center bg-no-repeat hidden md:block" style={{ backgroundImage: "url('/assets/hero-jaiswal.webp')" }} />
