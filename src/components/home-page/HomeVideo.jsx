            ...
            <div className="max-w-5xl mx-auto px-6">
                ...
                >
                    <div className="w-10 h-10 rounded-full overflow-hidden shrink-0">
                        <img src="/assets/lahiri-coaching.jpg" alt="Siddhartha Lahiri" className="w-full h-full object-cover object-top" />
                    </div>
                    <div>
                        <p className="text-white font-black uppercase tracking-wide text-sm">Siddhartha Lahiri</p>
                        <p className="text-white/50 text-xs font-medium">Head of Academy, Rajasthan Royals Academy Melbourne</p>
                    </div>
                </motion.div>
