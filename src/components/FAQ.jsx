...
const FAQ = () => {
    ...
    const programFaqs = [
        ...
        { q: "Is there a cost involved?", a: "Yes, there is an investment. The program is a premium performance experience with access to elite coaching and resources. Specific costs will be provided to successful applicants." },
    ...
    const selectionFaqs = [
        ...
        { q: "What if I am at the young end of the age groups?", a: "Younger players will be monitored as future talent. Assessment opportunities are likely for older age groups, but younger players benefit from early exposure to Royals systems and data tracking." },
