...
const DateOfBirthInput = ({ value, onChange, required = false }) => {
    ...
    const selectClass = "w-full bg-white border border-slate-200 rounded-lg px-4 py-3 focus:outline-none focus:border-rr-pink focus:ring-2 focus:ring-pink-200 transition-all text-rr-dark appearance-none";
