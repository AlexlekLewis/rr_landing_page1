...
import OnlineSeminars from './OnlineSeminars';
...
const FemaleEmpowerment = () => {
    usePageAnalytics('/female-empowerment', { sections: SECTIONS });
...
export default FemaleEmpowerment;
