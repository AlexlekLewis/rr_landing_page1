        ...
        <section className="relative min-h-screen flex items-center overflow-hidden bg-rr-dark">
            ...
            <div className="relative z-20 container mx-auto px-6 pt-32 pb-24 max-w-4xl">
                ...
                >
                    ...
                    <span className="text-xs font-bold text-rr-pink uppercase tracking-widest">Female Empowerment Program · 12 Weeks · Limited Spots</span>
                </motion.div>
                ...
                >
                    Female Empowerment & Skill Development — 12-Week Program
                </motion.p>
                ...
                >
                    For junior girls and women already playing cricket. Skill development, mental resilience, leadership, and a growth mindset — all in one performance environment.
                </motion.p>
                ...
                >
                    <div className="flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-4 py-2">
                        ...
                        <span className="text-white text-xs font-semibold uppercase tracking-wide">Bundoora Indoor Sports Centre</span>
                    </div>
                    <div className="flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-4 py-2">
                        <span className="text-rr-pink font-bold text-xs">🏏</span>
                        <span className="text-white text-xs font-semibold uppercase tracking-wide">12 Weeks</span>
                    </div>
                    <div className="flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-4 py-2">
                        <span className="text-rr-pink font-bold text-xs">👩‍🏫</span>
                        <span className="text-white text-xs font-semibold uppercase tracking-wide">Junior Girls & Women</span>
                    </div>
                </motion.div>
