                    ...
                    >
                        <div className="mt-4">
                            ...
                            <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-4 py-2 mb-6">
                                <span className="text-white font-bold text-sm"><span className="text-yellow-300 font-black">$27.50 per hour</span> — 12 hours of elite coaching</span>
                            </div>
                            ...
                            <p className="text-white/40 text-xs mt-4 leading-relaxed">
                                Includes 12 hours of elite coaching across 3 days. Training shirt purchased separately at $29.95. Don't miss out — places are limited.
                            </p>
                        </div>
                    </motion.div>
