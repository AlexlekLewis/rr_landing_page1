...
export const DIRECTOR = {
    ...
    bio: [
        ...
        'Outside the Academy he is Head of Academy at Fitzroy Doncaster, a Victorian Premier Cricket club — the top grade of club cricket in the state — where he is also Head Bowling Coach and a Senior Assistant Coach with the senior side. Before that, Cricket Victoria appointed him Junior Director of Coaching for the Northern Falcons region and used him as a coach educator, training other coaches rather than players. He founded his own junior academy at Preston and ran it for over ten years, and has been a representative head coach across the Diamond Valley and North Metro associations.',
