        ...
        <section className="relative min-h-[88vh] flex items-end overflow-hidden bg-rr-dark">
            <div className="absolute inset-0">
                <img
                    ...
                    alt="Indoor cricket lanes at the Rajasthan Royals Academy"
            ...
            <div className="relative w-full max-w-6xl mx-auto px-6 pb-20 pt-40 md:pb-24">
                ...
                >
                    <div className="inline-flex items-center gap-2 bg-rr-pink/10 border border-rr-pink/30 rounded-full px-4 py-2 mb-6 backdrop-blur-sm">
