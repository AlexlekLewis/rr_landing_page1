...
// Reusable Open Day landing page (Williamstown, Hallam, …) — same two-part
// structure and section anchors as the Mickleham original, so the Navbar
// "mickleham" variant (real site nav + on-page anchors) works unchanged.
            ...
            <main className="flex-1 w-full overflow-hidden">
                ...
                <section id="whats-on">
                    <div className="bg-rr-dark text-center pt-20 pb-14 px-6">
                        <p className="text-2xl md:text-4xl font-black text-rr-pink uppercase tracking-tight leading-none mb-2">{config.dateLine} · {config.timeRange}</p>
                        <p className="text-xs md:text-sm font-bold text-white/60 uppercase tracking-[0.25em] mb-7">{config.whatsOnVenueLine}</p>
                    ...
                    <div className="relative overflow-hidden min-h-[480px] md:min-h-[560px] flex" style={{ clipPath: 'polygon(0 0, 100% 0, 100% calc(100% - 7vw), 0 100%)' }}>
                        ...
                        <div className="relative z-10 w-full max-w-6xl mx-auto px-6 md:px-10 flex flex-col justify-center" style={{ paddingTop: '4rem', paddingBottom: 'calc(7vw + 3rem)' }}>
                            <p className="text-sm font-black uppercase tracking-[0.2em] mb-3" style={{ color: '#9DB6FF' }}>{config.part1Time} · Everyone welcome</p>
                    ...
                    <div className="relative overflow-hidden min-h-[520px] md:min-h-[600px] flex" style={{ marginTop: '-7vw', clipPath: 'polygon(0 7vw, 100% 0, 100% 100%, 0 100%)' }}>
                        ...
                        <div className="relative z-10 w-full max-w-6xl mx-auto px-6 md:px-10 flex flex-col justify-center" style={{ paddingTop: 'calc(7vw + 4rem)', paddingBottom: '4rem' }}>
                            <p className="text-sm font-black uppercase tracking-[0.2em] mb-3" style={{ color: '#F7A8D6' }}>{config.part2Time} · Ages 12+</p>
                    ...
                    <div className="max-w-5xl mx-auto px-6">
                        <div className="rounded-2xl border border-slate-200 bg-slate-50 p-8 md:p-10">
                            <div className="text-center mb-8">
                                ...
                                <h2 className="text-3xl md:text-4xl font-black text-rr-dark uppercase tracking-tight">{config.eliteHeading}</h2>
