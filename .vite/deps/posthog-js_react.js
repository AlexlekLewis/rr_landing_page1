...
// ../../../../../../../Users/alexlewis/Documents/Claude/Projects/Player DNA CArd/rr_landing_page1/node_modules/posthog-js/react/dist/esm/index.js
...
function useFeatureFlagPayload(flag) {
  ...
  var _c = (0, import_react.useState)(function() {
    var _a2;
    return (_a2 = client.getFeatureFlagResult(flag, { send_event: false })) === null || _a2 === void 0 ? void 0 : _a2.payload;
  }), featureFlagPayload = _c[0], setFeatureFlagPayload = _c[1];
  (0, import_react.useEffect)(function() {
    return client.onFeatureFlags(function() {
      var _a2;
      setFeatureFlagPayload((_a2 = client.getFeatureFlagResult(flag, { send_event: false })) === null || _a2 === void 0 ? void 0 : _a2.payload);
    });
  }, [client, flag]);
...
function useFeatureFlagResult(flag) {
  ...
  if (!((_a = client === null || client === void 0 ? void 0 : client.featureFlags) === null || _a === void 0 ? void 0 : _a.hasLoadedFlags) && (bootstrap === null || bootstrap === void 0 ? void 0 : bootstrap.featureFlags)) {
    ...
    return {
      ...
      variant: typeof bootstrappedValue === "string" ? bootstrappedValue : void 0,
