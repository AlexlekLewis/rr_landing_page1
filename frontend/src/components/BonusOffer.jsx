...
const BonusOffer = () => {
    ...
    return (
        <section className="py-16 bg-gradient-to-r from-yellow-400 to-yellow-500 text-slate-900">
            <div className="container mx-auto px-6 text-center">
                ...
                <Button onClick={scrollToForm} variant="secondary" className="border-none shadow-xl bg-white text-yellow-600 hover:bg-white/90">
